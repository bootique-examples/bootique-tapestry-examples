[![verify](https://github.com/bootique-examples/bootique-tapestry-demo/actions/workflows/verify.yml/badge.svg)](https://github.com/bootique-examples/bootique-tapestry-demo/actions/workflows/verify.yml)
